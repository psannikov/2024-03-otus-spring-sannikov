...
import static ru.otus.spring.psannikov.config.JsonDeserializer.OBJECT_MAPPER;
import static ru.otus.spring.psannikov.config.JsonDeserializer.TYPE_REFERENCE;
