package ru.otus.spring.psannikov.springbatch.shell;
...
import ru.otus.spring.psannikov.springbatch.config.AppProps;

import java.util.Properties;

import static ru.otus.spring.psannikov.springbatch.config.JobConfig.IMPORT_USER_JOB_NAME;
import static ru.otus.spring.psannikov.springbatch.config.JobConfig.INPUT_FILE_NAME;
import static ru.otus.spring.psannikov.springbatch.config.JobConfig.OUTPUT_FILE_NAME;
