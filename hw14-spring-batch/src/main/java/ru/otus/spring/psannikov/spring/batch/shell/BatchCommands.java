package ru.otus.spring.psannikov.spring.batch.shell;
...
import ru.otus.spring.psannikov.spring.batch.config.AppProps;

import java.util.Properties;

import static ru.otus.spring.psannikov.spring.batch.config.JobConfig.*;
