package ru.otus.spring.psannikov.spring.batch.config;
...
import ru.otus.spring.psannikov.spring.batch.repository.PersonRepository;
import ru.otus.spring.psannikov.spring.batch.service.CleanUpService;
import ru.otus.spring.psannikov.spring.batch.service.HappyBirthdayService;
...
public class JobConfig {
    ...
    @StepScope
    @Bean
    public MongoPagingItemReader<Person> reader(MongoOperations operations) {
